...
def validate_poly_regression(X_train, y_train, X_val, y_val, regressor=None, degree=3, max_features=None):
    bestRmse = 5
    bestModel = None
    bestDegree = None
    bestAlpha = None
    ...
    polyRegModel = make_pipeline(preprocessing, PolynomialFeatures(degree),  StandardScaler(), regressor)
...
outputPath = ('./augmented_polynomial_submission.csv')
