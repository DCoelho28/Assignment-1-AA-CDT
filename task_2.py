...
# degree chosen was 7, no need to do loops
def validate_poly_regression(X_train, y_train, X_val, y_val, regressor=None, degree=7, max_features=None):
    bestRmse = 2
    bestModel = None
    bestDegree = None
    bestAlpha = None
...
outputPath = ('./polynomial_submission.csv')
